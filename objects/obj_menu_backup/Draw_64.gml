...
if (menu == menu_configuracao) {
	...
	*/
	...
	//desenho da barra
    draw_roundrect_colour(global.barra_som_x + 25, global.barra_som_y, (global.barra_som_x + global.volume_som_barra_largura * global.volume_som)+12, global.barra_som_y + 12, c_white, c_blue, false);
	draw_roundrect_colour(global.barra_musica_x +25, global.barra_musica_y, (global.barra_musica_x + global.volume_musica_barra_largura * global.volume_musica) +12, global.barra_musica_y + 12, c_white, c_blue, false);
}
