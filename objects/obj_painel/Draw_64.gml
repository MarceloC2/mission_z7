...
if (instance_exists(obj_player_mission)) {
    ...
    draw_text(x_barra + largura_barra + 20, y_barra-5, string(global.pontuacao));
} else {
    draw_text(200,800,"Aguarde...");
}

// Desenha o texto VIDA
//draw_set_color(c_white);
//draw_text(x_barra, y_barra + altura_barra + 15, string(obj_player_mission.hp));
